...
?>
      ...
      <h1>Inscription</h1>
      <form action="<?php path("security/addResponsable") ?>" method="post">
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
            ...
            <input type="hidden" name="role" value="ROLE_ASSISTANT">

            <div class="row float-right">
             <button type="submit" class="btn btn-primary">Ajouter responsable</button></button>
            </div>
